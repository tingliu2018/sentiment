...
public class WordDeleter {
    ...
    private static List<String> commonWords = new ArrayList<>(Arrays.asList("the", "him", "his", "her", "he", "she", "a", "an", "of", "to",
            "not", "on", "you", "at", "from", "for", "over", "after", "about", "and", "up", "my", "in", "your", "with", "we"));

    public static void main(String[] args) throws FileNotFoundException {
        WordDeleter wd = new WordDeleter("C:\\Users\\Logan Brandt\\Documents\\internship\\ratingExtractor\\ratingExtractor\\sentiment\\ratingExtractor\\FemaleAverageCommentsPt1.txt");
